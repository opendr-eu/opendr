...
import sys
sys.path.insert(0,'/home/chumache/opendr_gesture/opendr/src/')
import unittest
import torch
import tempfile
import numpy as np
...
class DummyDataset(DatasetIterator):
    ...
    def __getitem__(self, i):
        ...
        sample = {
            ...
            'text_feats': torch.cat((torch.ones((1, self.args.max_seq_length_text)), torch.zeros(2,self.args.max_seq_length_text))).to(torch.long),
...
class TestIntentRecognitionLearner(unittest.TestCase):
    ...
    def test_fit(self):
        ...
        learner = IntentRecognitionLearner(text_backbone='prajjwal1/bert-tiny', mode='joint', device=DEVICE, log_path=tmp_dir, cache_path=tmp_dir, results_path = tmp_dir, output_path=tmp_dir)
    ...
    def test_save_load(self):
        ...
        learner = IntentRecognitionLearner(text_backbone='prajjwal1/bert-tiny', mode='joint', device=DEVICE, log_path=tmp_dir2, cache_path=tmp_dir2, results_path = tmp_dir2, output_path=tmp_dir2)
        train_set = DummyDataset(learner.train_config)
        learner.method.args.num_train_epochs=1
        ...
        new_learner = IntentRecognitionLearner(text_backbone='prajjwal1/bert-tiny', mode='joint', device=DEVICE, log_path=tmp_dir2, cache_path=tmp_dir2, results_path = tmp_dir2, output_path=tmp_dir2)
