...
class TestCoTransEncLearner(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.temp_dir = Path(
            "./tests/sources/tools/perception/activity_recognition/temp"
        )
        ...
        cls.train_ds = DummyTimeseriesDataset(
    ...
    def test_infer(self):
        dl = torch.utils.data.DataLoader(
            self.val_ds, batch_size=_BATCH_SIZE, num_workers=0
        )
    ...
    def test_optimize(self):
        ...
        (Path(self.learner.temp_path) / "weights/cotransenc_weights.onnx").unlink()
