...
class TestSkeletonBasedActionRecognition(unittest.TestCase):
    ...
    def test_eval(self):
        ...
        score = self.stbln_action_classifier.eval(validation_dataset, val_data_filename='val_joints.npy',
                                                  val_labels_filename='val_labels.pkl',
                                                  skeleton_data_type='joint')
    ...
    def test_multi_stream_eval(self):
        ...
        score_joints = self.stbln_action_classifier.eval(validation_dataset, val_data_filename='val_joints.npy',
                                                         val_labels_filename='val_labels.pkl',
                                                         skeleton_data_type='joint')
        score_bones = self.stbln_action_classifier.eval(validation_dataset, val_data_filename='val_joints.npy',
                                                        val_labels_filename='val_labels.pkl',
