...
# OpenDR dependencies
from opendr.control.single_demo_grasp.keypoint_detector_2d.training.single_demo_grasp_learner import SingleDemoGraspLearner
...
class TestSingleDemoGraspLearner(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.learner = SingleDemoGraspLearner(object_name = 'piston', data_directory = dir_temp, lr = 0.0008, batch_size = 2,
                        num_workers = 2, num_classes = 1, iters = 50,
                                                threshold = 0.8,    device = 'cpu')
        # Download all required files for testing
        cls.learner.download(path = dir_temp, verbose = True, object_name = "pendulum")
    ...
    def test_infer(self):
        sample_image = cv2.imread(os.path.join(dir_temp,"pendulum","images","val", "0.png"))
    ...
    def test_save_load(self):
        ...
        self.learner.load(os.path.join(dir_temp, "model_final.pth"))
