...
class TestLicense(unittest.TestCase):
    ...
    def setUp(self):
        ...
        skippedDirectoryPaths = [
            ...
            'src/opendr/perception/facial_exressoin_recognition/landmark_based_facial_expression_recognition/algorithm/feeders'
        ]
        ...
        skippedFilePaths = [
            ...
            'src/opendr/perception/facial_exressoin_recognition/landmark_based_facial_expression_recognition/algorithm/datasets/landmark_extractor.py'
        ]
