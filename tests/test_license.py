...
class TestLicense(unittest.TestCase):
    ...
    def setUp(self):
        ...
        skippedDirectoryPaths = [
            ...
            'projects/data_generation/synthetic_facial_image_generation',
            'src/opendr/perception/skeleton_based_action_recognition/algorithm',
        ...
        skippedFilePaths = [
            ...
            'projects/data_generation/synthetic_facial_image_generation/test_frontal.py',
            'projects/data_generation/synthetic_facial_image_generation/train.py',
