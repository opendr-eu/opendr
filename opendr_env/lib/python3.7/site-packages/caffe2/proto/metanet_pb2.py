...
_METANETDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='requestOnlyEmbeddings', full_name='caffe2.MetaNetDef.requestOnlyEmbeddings', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='aotConfig', full_name='caffe2.MetaNetDef.aotConfig', index=9,
...
_METANETDEF.fields_by_name['aotConfig'].message_type = caffe2_dot_proto_dot_caffe2__pb2._AOTCONFIG
