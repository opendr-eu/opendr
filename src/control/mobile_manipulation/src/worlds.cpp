...
void SimWorld::setModelState(std::string model_name,
...
void GazeboWorld::setModelState(std::string model_name,
                                tf::Transform world_transform,
                                RoboConf robo_config,
                                ros::Publisher &cmd_base_vel_pub) {
...
void RealWorld::setModelState(std::string model_name,
                              tf::Transform world_transform,
                              RoboConf robo_config,
                              ros::Publisher &cmd_base_vel_pub) {
    if (model_name != "pr2") {
