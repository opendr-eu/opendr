...
PYBIND11_MODULE(pybindings, m) {
  ...
  py::class_<RobotPR2>(m, "RobotPR2")
    ...
    .def("visualize", &RobotPR2::visualizeRobotPose, "Visualize trajectory.")
  ...
  py::class_<RobotTiago>(m, "RobotTiago")
    ...
    .def("visualize", &RobotTiago::visualizeRobotPose, "Visualize trajectory.")
  ...
  //        .def("visualize", &RobotHSR::visualizeRobotPose, "Visualize trajectory.")
