...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--yaw_poses', type=float, default=list_yaw, nargs='+', help='yaw poses list during testing')
        parser.add_argument('--pitch_poses', type=float, default=list_pitch, nargs='+', help='pitch poses list during testing')
