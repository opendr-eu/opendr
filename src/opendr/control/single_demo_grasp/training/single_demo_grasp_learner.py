...
class SingleDemoGraspLearner(Learner):
    ...
    def __init__(self, object_name = None, data_directory = None, lr = 0.0008, batch_size = 1,
        ...
        self.output_dir =  os.path.join(self.dataset_dir, object_name, "output")
    ...
    def _prepare_datasets(self):
        ...
        bbx_train = np.load(self.dataset_dir + "/"+ self.object_name + '/images/annotations/boxes_train.npy', encoding='bytes')
        bbx_val = np.load(self.dataset_dir + "/"+ self.object_name + '/images/annotations/boxes_val.npy', encoding='bytes')
        kps_train = np.load(self.dataset_dir + "/"+ self.object_name + '/images/annotations/kps_train.npy', encoding='bytes')
        kps_val = np.load(self.dataset_dir + "/"+ self.object_name + '/images/annotations/kps_val.npy', encoding='bytes')
