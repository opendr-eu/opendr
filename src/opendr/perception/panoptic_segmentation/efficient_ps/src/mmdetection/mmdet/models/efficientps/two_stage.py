...
class TwoStageDetector(BaseDetector, RPNTestMixin, BBoxTestMixin, MaskTestMixin):
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, gt_bboxes_ignore=None, gt_masks=None, proposals=None):
        ...
        Args:
            ...
            img_metas (list[dict]): list of image info dict where each dict
                ...
                `mmdetetection/datasets/pipelines/formatting.py:Collect`.
    ...
    async def async_simple_test(self, img, img_meta, proposals=None, rescale=False):
        ...
        det_bboxes, det_labels = await self.async_test_bboxes(x, img_meta, proposal_list, self.test_cfg.rcnn, rescale=rescale)
