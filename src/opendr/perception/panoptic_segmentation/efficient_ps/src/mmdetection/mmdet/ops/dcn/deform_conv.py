...
class DeformConvFunction(Function):
    ...
    def forward(ctx, input, offset, weight, stride=1, padding=0, dilation=1, groups=1, deformable_groups=1, im2col_step=64):
        ...
        if not input.is_cuda:
            ...
            deform_conv_cuda.deform_conv_forward_cuda(input, weight, offset, output, ctx.bufs_[0], ctx.bufs_[1], weight.size(3),
    ...
    def backward(ctx, grad_output):
        ...
        if not grad_output.is_cuda:
            ...
            if ctx.needs_input_grad[0] or ctx.needs_input_grad[1]:
                ...
                deform_conv_cuda.deform_conv_backward_input_cuda(input, offset, grad_output, grad_input,
            ...
            if ctx.needs_input_grad[2]:
                ...
                deform_conv_cuda.deform_conv_backward_parameters_cuda(input, offset, grad_output,
...
class ModulatedDeformConvFunction(Function):
    ...
    def forward(ctx, input, offset, mask, weight, bias=None, stride=1, padding=0, dilation=1, groups=1, deformable_groups=1):
        ...
        deform_conv_cuda.modulated_deform_conv_cuda_forward(input, weight, bias, ctx._bufs[0], offset, mask, output,
    ...
    def backward(ctx, grad_output):
        ...
        deform_conv_cuda.modulated_deform_conv_cuda_backward(input, weight, bias, ctx._bufs[0], offset, mask, ctx._bufs[1],
