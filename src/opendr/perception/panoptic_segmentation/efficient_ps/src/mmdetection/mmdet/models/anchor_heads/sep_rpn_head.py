...
from mmdet.ops import nms, DepthwiseSeparableConvModule
...
class SepRPNHead(AnchorHead):
    ...
    def _init_layers(self):
        self.rpn_conv = DepthwiseSeparableConvModule(self.in_channels,
                                                     self.feat_channels,
                                                     3,
                                                     padding=1,
    ...
    def loss(self, cls_scores, bbox_preds, gt_bboxes, img_metas, cfg, gt_bboxes_ignore=None):
        losses = super(SepRPNHead, self).loss(cls_scores,
                                              bbox_preds,
                                              gt_bboxes,
                                              None,
                                              img_metas,
