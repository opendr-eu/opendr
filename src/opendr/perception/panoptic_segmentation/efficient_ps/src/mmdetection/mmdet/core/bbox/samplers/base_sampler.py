...
class BaseSampler(metaclass=ABCMeta):
    ...
    def sample(self, assign_result, bboxes, gt_bboxes, gt_labels=None, **kwargs):
        ...
        Example:
            >>> from mmdetetection.core.bbox import RandomSampler
            >>> from mmdetetection.core.bbox import AssignResult
            >>> from mmdetetection.core.bbox.demodata import ensure_rng, random_boxes
            >>> rng = ensure_rng(None)
