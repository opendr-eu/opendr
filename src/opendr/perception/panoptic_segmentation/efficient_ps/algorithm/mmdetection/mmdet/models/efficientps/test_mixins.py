...
from mmdet.core import (bbox2roi, bbox_mapping, merge_aug_bboxes, merge_aug_masks, merge_aug_proposals, multiclass_nms)
...
class BBoxTestMixin(object):
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        det_bboxes, det_labels = multiclass_nms(merged_bboxes, merged_scores, rcnn_test_cfg.score_thr, rcnn_test_cfg.nms,
...
class MaskTestMixin(object):
    ...
    def simple_test_mask_logits(self, x, img_metas, det_bboxes, det_labels, rescale=False):
        # image shape of the first image in the batch (only one)
        ori_shape = img_metas[0]['ori_shape']
        scale_factor = img_metas[0]['scale_factor']
        if det_bboxes.shape[0] == 0:
