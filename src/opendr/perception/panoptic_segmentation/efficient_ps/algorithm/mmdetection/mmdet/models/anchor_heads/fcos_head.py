...
class FCOSHead(nn.Module):
    ...
    def get_bboxes(self, cls_scores, bbox_preds, centernesses, img_metas, cfg, rescale=None):
        ...
        for img_id in range(len(img_metas)):
            ...
            det_bboxes = self.get_bboxes_single(cls_score_list, bbox_pred_list, centerness_pred_list, mlvl_points, img_shape,
    ...
    def fcos_target(self, points, gt_bboxes_list, gt_labels_list):
        ...
        labels_list, bbox_targets_list = multi_apply(self.fcos_target_single,
                                                     gt_bboxes_list,
                                                     gt_labels_list,
    ...
    def fcos_target_single(self, gt_bboxes, gt_labels, points, regress_ranges, num_points_per_lvl):
        ...
        inside_regress_range = (max_regress_distance >= regress_ranges[..., 0]) & (max_regress_distance <= regress_ranges[...,
                                                                                                                          1])
