...
class DeformRoIPoolingFunction(Function):
    ...
    def forward(ctx,
        ...
        deform_pool_cuda.deform_psroi_pooling_cuda_forward(data, rois, offset, output, output_count, ctx.no_trans,
    ...
    def backward(ctx, grad_output):
        ...
        deform_pool_cuda.deform_psroi_pooling_cuda_backward(grad_output, data, rois, offset, output_count, grad_input,
...
class DeformRoIPooling(nn.Module):
    ...
    def forward(self, data, rois, offset):
        ...
        return deform_roi_pooling(data, rois, offset, self.spatial_scale, self.out_size, self.out_channels, self.no_trans,
...
class DeformRoIPoolingPack(DeformRoIPooling):
    def __init__(self,
        ...
        super(DeformRoIPoolingPack, self).__init__(spatial_scale, out_size, out_channels, no_trans, group_size, part_size,
    ...
    def forward(self, data, rois):
        ...
        if self.no_trans:
            ...
            offset = data.new_empty(0)
            x = deform_roi_pooling(data, rois, offset, self.spatial_scale, self.out_size, self.out_channels, True,
                                   self.group_size, self.part_size, self.sample_per_part, self.trans_std)
...
class ModulatedDeformRoIPoolingPack(DeformRoIPooling):
    def __init__(self,
                 ...
                 num_mask_fcs=2,
                 deform_fc_channels=1024):
        super(ModulatedDeformRoIPoolingPack, self).__init__(spatial_scale, out_size, out_channels, no_trans, group_size,
    ...
    def forward(self, data, rois):
        ...
        if self.no_trans:
            ...
            return deform_roi_pooling(data, rois, offset, self.spatial_scale, self.out_size, self.out_channels, self.no_trans,
                                      self.group_size, self.part_size, self.sample_per_part, self.trans_std) * mask
