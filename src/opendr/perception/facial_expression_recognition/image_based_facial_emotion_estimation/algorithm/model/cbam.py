"""
Implementation of CBAM attention method (Sanghyun Woo, et al., 2018).
Code taken from: https://github.com/Jongchan/attention-module
"""
...
class CBAM(nn.Module):
    ...
    def forward(self, x):
        x_out, attn_ch = self.ChannelGate(x)
        x_out, attn_sp = self.SpatialGate(x_out)
        return x_out, attn_ch, attn_sp  # Shape: NxCxHxW
