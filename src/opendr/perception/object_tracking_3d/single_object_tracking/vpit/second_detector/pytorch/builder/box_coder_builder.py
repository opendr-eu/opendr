from opendr.perception.object_tracking_3d.single_object_tracking.voxel_bof.second_detector.pytorch.core.box_coders import (
    BevBoxCoderTorch,
...
def build(box_coder_config):
    ...
    if box_coder_type == "ground_box3d_coder":
        ...
        return BevBoxCoderTorch(
            cfg.linear_dim, cfg.encode_angle_vector, cfg.z_fixed, cfg.h_fixed
        )
    else:
