...
from opendr.perception.object_detection_3d.voxel_object_detection_3d.second_detector.protos import (
    optimizer_pb2 as second_dot_protos_dot_optimizer__pb2,
)
from opendr.perception.object_detection_3d.voxel_object_detection_3d.second_detector.protos import (
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=_b(
        ...
        'e_mixed_precision\x18\t \x01(\x08\x12\x19\n\x11loss_scale_factor\x18\n \x01(\x02\x12!\n\x19\x63le' +
        'ar_metrics_every_epoch\x18\x0b \x01(\x08\x62\x06proto3'
    ),
    dependencies=[
        second_dot_protos_dot_optimizer__pb2.DESCRIPTOR,
...
_REGULARIZER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="l1_regularizer",
            full_name="second.protos.Regularizer.l1_regularizer",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="l2_regularizer",
            full_name="second.protos.Regularizer.l2_regularizer",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            ...
            full_name="second.protos.Regularizer.regularizer_oneof",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_L1REGULARIZER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="weight",
            full_name="second.protos.L1Regularizer.weight",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_L2REGULARIZER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="weight",
            full_name="second.protos.L2Regularizer.weight",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_TRAINCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="optimizer",
            full_name="second.protos.TrainConfig.optimizer",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.TrainConfig.inter_op_parallelism_threads",
            index=1,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.TrainConfig.intra_op_parallelism_threads",
            index=2,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="steps",
            full_name="second.protos.TrainConfig.steps",
            index=3,
            number=5,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="steps_per_eval",
            full_name="second.protos.TrainConfig.steps_per_eval",
            index=4,
            number=6,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.TrainConfig.save_checkpoints_secs",
            index=5,
            number=7,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.TrainConfig.save_summary_steps",
            index=6,
            number=8,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.TrainConfig.enable_mixed_precision",
            index=7,
            number=9,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.TrainConfig.loss_scale_factor",
            index=8,
            number=10,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="clear_metrics_every_epoch",
            full_name="second.protos.TrainConfig.clear_metrics_every_epoch",
            index=9,
            number=11,
            type=8,
            cpp_type=7,
...
_TRAINCONFIG.fields_by_name[
    "optimizer"
].message_type = second_dot_protos_dot_optimizer__pb2._OPTIMIZER
