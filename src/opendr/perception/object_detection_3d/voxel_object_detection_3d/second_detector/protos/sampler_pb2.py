...
_GROUP_NAMETOMAXNUMENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="second.protos.Group.NameToMaxNumEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="second.protos.Group.NameToMaxNumEntry.value",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
_GROUP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name_to_max_num",
            full_name="second.protos.Group.name_to_max_num",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SAMPLER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="database_info_path",
            full_name="second.protos.Sampler.database_info_path",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="sample_groups",
            full_name="second.protos.Sampler.sample_groups",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.Sampler.database_prep_steps",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.Sampler.global_random_rotation_range_per_object",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="rate",
            full_name="second.protos.Sampler.rate",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
...
Group = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        NameToMaxNumEntry=_reflection.GeneratedProtocolMessageType(
            "NameToMaxNumEntry",
            (_message.Message,),
            dict(
