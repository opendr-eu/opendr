# Copied from https://github.com/pytorch/vision/blob/main/torchvision/models/feature_extraction.py
# since we are using torchvision 0.10.0 and the feature extractor is only available in >= 0.11.0
