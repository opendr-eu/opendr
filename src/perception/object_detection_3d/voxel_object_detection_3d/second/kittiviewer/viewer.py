...
from perception.object_detection_3d.voxel_object_detection_3d.second.core.point_cloud.point_cloud_ops import (
    points_to_voxel,
)
from perception.object_detection_3d.voxel_object_detection_3d.second.core.region_similarity import (
    DistanceSimilarity,
    NearestIouSimilarity,
    RotateIouSimilarity,
)
from perception.object_detection_3d.voxel_object_detection_3d.second.core.sample_ops import (
    DataBaseSamplerV2,
)
...
from perception.object_detection_3d.voxel_object_detection_3d.second.kittiviewer.glwidget import (
    KittiGLViewWidget,
)
from perception.object_detection_3d.voxel_object_detection_3d.second.protos import (
    pipeline_pb2,
)
from perception.object_detection_3d.voxel_object_detection_3d.second.utils import (
    bbox_plot,
)
...
from perception.object_detection_3d.voxel_object_detection_3d.second.pytorch.inference import (
...
class KittiViewer(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.w_cb_gt_curcls.stateChanged.connect(self.on_gt_checkbox_statechanged)
        ...
        self.gt_combobox.currentTextChanged.connect(self.on_gt_combobox_changed)
        ...
        self.w_cb_dt_curcls.stateChanged.connect(self.on_dt_checkbox_statechanged)

        self.dt_combobox = QComboBox()
        self.dt_combobox.addItem("All")
        self._current_dt_cls_ids = None
        self._current_dt_cls_idx = 0
        self.dt_combobox.currentTextChanged.connect(self.on_dt_combobox_changed)
        ...
        self.w_prev.clicked.connect(partial(self.on_nextOrPrevCurClsPressed, prev=True))
    ...
    def draw_gt_in_image(self):
        ...
        if self.current_image is not None:
            bbox_plot.draw_3d_bbox_in_ax(self.w_plt.ax, boxes_3d_p2, colors="b")
