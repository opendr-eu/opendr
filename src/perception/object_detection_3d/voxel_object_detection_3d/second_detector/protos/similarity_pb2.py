...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.RegionSimilarityCalculator.rotate_iou_similarity",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.RegionSimilarityCalculator.nearest_iou_similarity",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="second.protos.RegionSimilarityCalculator.distance_similarity",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            ...
            full_name="second.protos.RegionSimilarityCalculator.region_similarity",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
].message_type = _ROTATEIOUSIMILARITY
_REGIONSIMILARITYCALCULATOR.fields_by_name[
    "nearest_iou_similarity"
].message_type = _NEARESTIOUSIMILARITY
_REGIONSIMILARITYCALCULATOR.fields_by_name[
    "distance_similarity"
].message_type = _DISTANCESIMILARITY
