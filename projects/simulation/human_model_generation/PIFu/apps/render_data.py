import numpy as np
from projects.simulation.human_model_generation.PIFu.lib.renderer.mesh import load_obj_mesh, compute_tangent
from projects.simulation.human_model_generation.PIFu.lib.renderer.camera import Camera
import os
import cv2
import math
import random
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--ms_rate', type=int, default=1, help='higher ms rate results in less aliased output. '
                                                                     'MESA renderer only supports ms_rate=1.')
    parser.add_argument('-e', '--egl', action='store_true', help='egl rendering option. use this when rendering with '
                                                                 'headless server with NVIDIA GPU')
