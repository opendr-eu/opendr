        ...
        for i, data_i in enumerate(range(len(dataloaders[0]) * opt.render_thread)):
            ...
            for n, name in enumerate(names):
                ...
                for b in range(generate_rotateds[n].shape[0]):
                    ...
                    #print(FID)
                    rotated_file_savepath = create_paths(save_paths[n], img_path[b], FID+'_orig', folderlevel=folderlevel, pose=poses[b])
                    ...
                    if opt.align:
                        aligned_file_savepath = create_paths(save_paths[n], img_path[b], FID+'_aligned', folderlevel=folderlevel, pose=poses[b])
