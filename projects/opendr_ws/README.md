...
11. [Semantic Segmentation BiSeNet](src/opendr_perception/README.md#semantic-segmentation-bisenet-ros-node)
12. [Semantic Segmentation YOLOv8](src/opendr_perception/README.md#semantic-segmentation-yolov8-ros-node)
13. [Binary High Resolution](src/opendr_perception/README.md#binary-high-resolution-ros-node)
14. [Image-based Facial Emotion Estimation](src/opendr_perception/README.md#image-based-facial-emotion-estimation-ros-node)
15. [Landmark-based Facial Expression Recognition](src/opendr_perception/README.md#landmark-based-facial-expression-recognition-ros-node)
16. [Skeleton-based Human Action Recognition](src/opendr_perception/README.md#skeleton-based-human-action-recognition-ros-nodes)
17. [Video Human Activity Recognition](src/opendr_perception/README.md#video-human-activity-recognition-ros-node)
18. [RGB Hand Gesture Recognition](src/opendr_perception/README.md#rgb-gesture-recognition-ros-node)
