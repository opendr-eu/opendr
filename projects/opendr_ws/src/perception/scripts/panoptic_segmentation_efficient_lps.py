...
import matplotlib
import rospy
from sensor_msgs.msg import Image as ROS_Image, PointCloud as ROS_PointCloud
    ...
    def callback(self, data: ROS_PointCloud):
        ...
        try:
            ...
            if self._visualization_publisher is not None and self._visualization_publisher.get_num_connections() > 0:
                panoptic_image = EfficientLpsLearner.visualize(image, prediction, show_figure=False,
