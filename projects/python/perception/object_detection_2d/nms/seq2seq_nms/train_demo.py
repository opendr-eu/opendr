...
parser.add_argument("--checkpoint_freq", help="Frequency in-between checkpoint saving",
                    type=int, default=1)
...
seq2SeqNMSLearner.fit(dataset=args.dataset, use_ssd=args.use_ssd, ssd_model=args.ssd_model,
