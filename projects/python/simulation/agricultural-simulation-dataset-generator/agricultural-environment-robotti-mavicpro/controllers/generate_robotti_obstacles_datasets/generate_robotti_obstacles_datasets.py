...
if(useRobotti):
    ...
    #backgrounds = ['noon_cloudy_countryside', 'noon_stormy_empty', 'dawn_cloudy_empty', 'dusk']
    
    backgrounds = ['noon_cloudy_countryside']
    backgrounds = ['dawn_cloudy_empty']
    backgrounds = ['noon_stormy_empty']
    # backgrounds = ['dusk']
    ...
    def generate_environment(supervisor, field_size):
        ...
        field_mud_node = supervisor.getFromDef("FIELD_MUD")
    ...
    def move_robot(robot, field, turn_right=False, turn_left=False):
        ...
        if(already_set_the_velocity==False):
