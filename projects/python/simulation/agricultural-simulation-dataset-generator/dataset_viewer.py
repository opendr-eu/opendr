...
path_ugv = '/agricultural-environment-robotti-mavicpro/datasets/noon_stormy_empty_193sec/UGV/'
path_uav = '/agricultural-environment-robotti-mavicpro/datasets/noon_stormy_empty_193sec/UAV/'
